...
Bibgrep indeksuje i wydajnie przeszukuje pliki BibTeXa. Użycie go jest
podobne do polecenia grep, a polecenia wykorzystują składnię w stylu
Googli. Bibgrep tworzy indeks dla każdego przetwarzanego pliku BibTeXa
i utrzymuje wynik w ~/.bibgrep.idx (domyślnie). Kontroluje datę
